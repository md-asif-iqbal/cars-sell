...
const Banners = () => {
  return (
    <div className="bg-cover bg-center Apps">
      <section class="backdrop-blur-sm ">
        <div class="max-w-screen-xl px-4 py-32 mx-auto lg:h-screen lg:items-center lg:flex">
          <div class="max-w-xl mx-auto text-center">
            ...
            <p class="mt-4 sm:leading-relaxed sm:text-xl text-white">
            ...
            <div class="flex flex-wrap justify-center gap-4 mt-8">
              ...
              <a
                class="block w-full px-12 py-3 text-sm font-medium text-red-600 rounded bg-gray-100 shadow sm:w-auto hover:text-red-700 active:text-red-500 focus:outline-none focus:ring"
                href="/about"
              >
                Learn More
              </a>
